 ...
 */
class OutputSurfaceAlone implements SurfaceTexture.OnFrameAvailableListener {
   ...
   private TextureRenderAlone mTextureRender;
    ...
    */
   public OutputSurfaceAlone(int width, int height ) {
      if ( width <= 0 || height <= 0 ) {
    ...
    */
   private void setup() {
      mTextureRender = new TextureRenderAlone();
