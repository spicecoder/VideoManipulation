...
public class FileUtils {
    ...
    public static File saveTempFile(String fileName, Context context, Uri uri) {
        ...
        try {
            ...
            File tempFolder = new File(Environment.getExternalStorageDirectory().getPath() + File.separator +  VIDEO_COMPRESSOR_APPLICATION_DIR_NAME +  VIDEO_COMPRESSOR_TEMP_DIR);
